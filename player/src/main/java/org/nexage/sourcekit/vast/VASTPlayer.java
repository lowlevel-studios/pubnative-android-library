...
public class VASTPlayer {
    ...
    private String skipButtonName = "Skip";
    private int skipTimeInSeconds = 0;
    ...
    public void loadVideoWithData(final String xmlData, String skipButton, int skipTimeSeconds) {

        VASTLog.v(TAG, "loadVideoWithData\n" + xmlData);
        vastModel = null;
        skipButtonName = skipButton;
        skipTimeInSeconds = skipTimeSeconds;
        if (NetworkTools.connectedToInternet(context)) {
    ...
    public void loadVideoWithData(final String xmlData) {
        ...
        this.loadVideoWithData(xmlData, "", -1);
    }
    ...
    public void play() {
        ...
        if (vastModel != null) {
            ...
            if (NetworkTools.connectedToInternet(context)) {
                ...
                vastPlayerIntent.putExtra(VASTActivity.EXTRA_MODEL, vastModel);
                vastPlayerIntent.putExtra(VASTActivity.EXTRA_SKIP_NAME, skipButtonName);
                vastPlayerIntent.putExtra(VASTActivity.EXTRA_SKIP_TIME, skipTimeInSeconds);
